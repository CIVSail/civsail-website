...
import { Users, ArrowLeft, Clock, DollarSign, Award } from 'lucide-react';
import { Card } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { SectorFeedbackForm } from '@/components/sectors/SectorFeedbackForm';

export default function CruiseShipsSectorPage() {
  const sector = {
    title: 'Cruise Ships',
    ...
    content: [
      ...
      'Hotel and hospitality careers',
      'Expedition cruise opportunities',
      'Contract lengths and rotations',
      'International crew dynamics',
      'Career progression paths',
      'Small ship vs mega cruise experience',
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        ...
        >
          <div className="inline-flex p-4 rounded-2xl bg-pink-500/20 border border-pink-500/30 mb-8">
          ...
          <p className="text-xl text-pink-400 mb-6">{sector.subtitle}</p>
          ...
          <SectorFeedbackForm sectorTitle="Cruise Ships" />
