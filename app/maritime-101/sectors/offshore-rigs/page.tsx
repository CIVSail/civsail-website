...
import { Building2, ArrowLeft, Clock, DollarSign, Award } from 'lucide-react';
import { Card } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { SectorFeedbackForm } from '@/components/sectors/SectorFeedbackForm';

export default function OffshoreRigsSectorPage() {
  const sector = {
    title: 'Offshore Oil Rigs',
    subtitle: 'Platform & Drilling Operations',
    description: 'Work aboard fixed and floating drilling platforms, production facilities, and mobile offshore drilling units (MODUs). Premium pay for demanding conditions.',
    stats: { rotation: '14/14 or 21/21', pay: 'Day rate $300-700', benefits: 'Varies by employer' },
    content: [
      'Types of offshore platforms and rigs',
      'MODU positions: drillships, semisubs, jackups',
      'Production platform opportunities',
      'Day rate compensation structures',
      'HUET, BOSIET and offshore certifications',
      'Gulf of Mexico vs international opportunities',
      'Offshore medic and specialized positions',
      'Career progression in offshore drilling',
    ],
  };
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center max-w-3xl mx-auto">
          <div className="inline-flex p-4 rounded-2xl bg-slate-500/20 border border-slate-500/30 mb-8">
          ...
          <p className="text-xl text-slate-400 mb-6">{sector.subtitle}</p>
          ...
          <SectorFeedbackForm sectorTitle="Offshore Oil Rigs" />
