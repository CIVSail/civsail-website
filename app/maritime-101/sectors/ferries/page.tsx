...
import { Ship, ArrowLeft, Clock, DollarSign, Award } from 'lucide-react';
import { Card } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { SectorFeedbackForm } from '@/components/sectors/SectorFeedbackForm';

export default function FerriesSectorPage() {
  const sector = {
    title: 'Ferries',
    subtitle: 'Passenger & Vehicle Ferries',
    description: 'Passenger and vehicle ferries operating scheduled routes. Day work schedules possible, state ferry systems offer government benefits.',
    stats: { rotation: 'Daily/Weekly', pay: '$45K-120K/year', benefits: 'State or company' },
    content: [
      'State ferry system opportunities',
      'Private ferry operators',
      'Day work vs rotation schedules',
      'Passenger vessel certifications',
      'High-speed ferry operations',
      'Vehicle ferry deck operations',
      'State employee benefits packages',
      'Urban ferry growth markets',
    ],
  };
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center max-w-3xl mx-auto">
          <div className="inline-flex p-4 rounded-2xl bg-sky-500/20 border border-sky-500/30 mb-8">
          ...
          <p className="text-xl text-sky-400 mb-6">{sector.subtitle}</p>
          ...
          <SectorFeedbackForm sectorTitle="Ferries" />
