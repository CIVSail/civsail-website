...
import { Globe, ArrowLeft, Clock, DollarSign, Award } from 'lucide-react';
import { Card } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { SectorFeedbackForm } from '@/components/sectors/SectorFeedbackForm';

export default function CommercialDeepSeaSectorPage() {
  const sector = {
    title: 'Commercial Deep Sea',
    subtitle: 'Container, Tanker & Bulk Carriers',
    description: 'International and coastwise shipping on large oceangoing vessels. Container ships, tankers, and bulk carriers moving cargo across oceans and between major ports.',
    stats: { rotation: '60-120 days', pay: 'Union scale + OT', benefits: 'Full medical, pension' },
    content: [
      'Container ship operations and major carriers',
      'Tanker industry: crude, product, and chemical',
      'Bulk carrier operations and cargo types',
      'Jones Act vs. international flag opportunities',
      'Union hiring halls: AMO, MEBA, SIU, SUP',
      'Typical rotation schedules and port calls',
      'Career progression on deep sea vessels',
      'International vs. coastwise trade routes',
    ],
  };
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="text-center max-w-3xl mx-auto">
          <div className="inline-flex p-4 rounded-2xl bg-blue-500/20 border border-blue-500/30 mb-8">
          ...
          <p className="text-xl text-blue-400 mb-6">{sector.subtitle}</p>
          ...
          <SectorFeedbackForm sectorTitle="Commercial Deep Sea" />
