...
import { Sailboat, ArrowLeft, Clock, DollarSign, Award } from 'lucide-react';
import { Card } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Badge } from '@/components/ui/badge';
import { SectorFeedbackForm } from '@/components/sectors/SectorFeedbackForm';

export default function YachtsSectorPage() {
  const sector = {
    title: 'Yachts',
    ...
    content: [
      'Private yacht positions and hierarchy',
      'Charter yacht operations',
      'MCA certification requirements',
      'STCW for yacht crew',
      'Crew agencies and job boards',
      'Tips and compensation structures',
      'Seasonal vs year-round positions',
      'Transitioning from commercial to yachts',
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
        ...
        >
          <div className="inline-flex p-4 rounded-2xl bg-indigo-500/20 border border-indigo-500/30 mb-8">
            <Sailboat className="w-12 h-12 text-indigo-400" />
          </div>
          ...
          <p className="text-xl text-indigo-400 mb-6">{sector.subtitle}</p>
          ...
          <SectorFeedbackForm sectorTitle="Yachts" />

          <Link href="/maritime-101/careers-and-sectors">
            <Button
              size="lg"
              className="bg-slate-800/50 text-slate-300 border border-slate-700 hover:bg-slate-700"
            >
