  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-slate-800 to-violet-800">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/80 leading-relaxed mb-8">
                High-speed, shallow-draft vessels supporting special operations 
                and theater security cooperation. These fast transports enable 
                rapid deployment and flexible maritime operations.
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center text-white/60">
          <p className="mb-2">
            Information based on current T-EPF operations and sailor experiences
          </p>
          <p className="text-sm">
