  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-900 via-slate-800 to-amber-800">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/80 leading-relaxed mb-8">
                Salvage and rescue vessels providing emergency response, diving
                support, and heavy lift capabilities. These specialized ships
                respond to maritime emergencies and recovery operations
                worldwide.
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center text-white/60">
          <p className="mb-2">
            Information based on current T-ARS operations and sailor experiences
          </p>
          <p className="text-sm">
