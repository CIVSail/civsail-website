...
export default function TARCShipPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-slate-800 to-green-800">
      {/* Hero Section */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-white mb-6">
                T-ARC
                <span className="block text-2xl lg:text-3xl font-normal text-emerald-300 mt-2">
                  Cable Repair Ship
                </span>
              </h1>
              <p className="text-xl text-white/80 leading-relaxed mb-8">
                Specialized vessels maintaining and repairing underwater communication 
                cables critical to military operations. These unique ships ensure 
                global communications infrastructure remains operational.
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white/5 backdrop-blur-lg border border-white/20 rounded-2xl p-8 lg:p-12">
          ...
          {activeSection === 'overview' && (
            <div className="space-y-8">
              <div className="flex items-center mb-8">
                <Ship className="w-8 h-8 text-emerald-400 mr-4" />
          ...
          {activeSection === 'operations' && (
            <div className="space-y-8">
              <div className="flex items-center mb-8">
                <DollarSign className="w-8 h-8 text-emerald-400 mr-4" />
          ...
          {activeSection === 'life-aboard' && (
            <div className="space-y-8">
              <div className="flex items-center mb-8">
                <Home className="w-8 h-8 text-emerald-400 mr-4" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center text-white/60">
          <p className="mb-2">
            Information based on current T-ARC operations and sailor experiences
          </p>
          <p className="text-sm">
