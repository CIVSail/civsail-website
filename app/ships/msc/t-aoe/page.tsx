...
export default function TAOEShipPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-900 via-slate-800 to-red-800">
      {/* Hero Section */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/80 leading-relaxed mb-8">
                Multi-product replenishment ships providing fuel, ammunition, provisions, 
                and spare parts to carrier strike groups. Known for demanding operational 
                tempo and highest compensation in the MSC fleet.
              </p>
