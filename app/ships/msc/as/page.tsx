...
export default function ASShipPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-800 to-slate-700">
      {/* Hero Section */}
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-gray-600/20 to-slate-600/20" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center bg-gray-500/20 text-gray-300 px-4 py-2 rounded-full text-sm font-medium mb-6">
              ...
              <p className="text-xl text-white/80 leading-relaxed mb-8">
                Support vessels providing maintenance, supplies, and services to 
                submarines and submarine crews. These floating repair shops keep 
                the submarine fleet operational worldwide.
              </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white/5 backdrop-blur-lg border border-white/20 rounded-2xl p-8 lg:p-12">
          ...
          {activeSection === 'overview' && (
            <div className="space-y-8">
              <div className="flex items-center mb-8">
                <Ship className="w-8 h-8 text-gray-400 mr-4" />
          ...
          {activeSection === 'life-aboard' && (
            <div className="space-y-8">
              <div className="flex items-center mb-8">
                <Home className="w-8 h-8 text-gray-400 mr-4" />
          ...
          {activeSection === 'ships-ports' && (
            <div className="space-y-8">
              <div className="flex items-center mb-8">
                <MapPin className="w-8 h-8 text-gray-400 mr-4" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center text-white/60">
          <p className="mb-2">
            Information based on current AS operations and sailor experiences
          </p>
          <p className="text-sm">
