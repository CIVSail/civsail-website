          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/80 leading-relaxed mb-8">
                Fuel tankers providing underway replenishment of petroleum products 
                to Navy ships and shore installations. The backbone of naval fuel 
                logistics supporting sustained operations worldwide.
              </p>
